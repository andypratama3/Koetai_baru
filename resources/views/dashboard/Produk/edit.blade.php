            ...
            <div class="card-body">
                ...
                <form action="{{ route('dashboard.produk.update',$produk->slug) }} " method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="file" id="formFile" value="{{ $produk->foto }}" name="foto">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" value="{{ $produk->deskripsi }}" name="deskripsi" id="deskripsi">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="inputEmail" class="col-sm-2 col-form-label">Stock</label>
                        <div class="col-sm-10">
                            <input class="form-control" value="{{ $produk->stock }}" name="stock" id="stock">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="inputEmail" class="col-sm-2 col-form-label">Kategori Produk</label>
                        <div class="col-sm-10">
                            @forelse ($produk->kategoris as $key => $kategori)
