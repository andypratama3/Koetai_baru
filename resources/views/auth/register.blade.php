              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Masukan Data Untuk Mendaftar</p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" action="{{ route('register') }}" method="POST">
                    ...
                    <div class="col-12">
                      ...
                      <div class="invalid-feedback">Masukan Kata sandi Anda</div>
                    </div>

                    <div class="col-12">
                        <label for="yourPassword" class="form-label">Konfirmasi Sandi</label>
