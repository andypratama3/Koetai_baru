 ...
 <div class="container-belanja">
        <nav class="nav-belanja">
            <ul>
                ...
                <li class="belanja-mchan" id="nav-mchan">MERCHANDISE</li>
            </ul>
        </nav>
        ...
        <!-- MODAL BAJU -->
        <div class="modal fade" id="modalss" tabindex="-1" aria-labelledby="" aria-hidden="true">
...
@include('layouts.script')
    ...
    $(document).ready(function () {
        $(document).on('click', '#details', function () {
            ...
            // var Url_gambar = "{{ asset('storage/img/produk/";
            $('#id').text(id);
            $('#nama').text(nama);
            $('#harga').text(harga);
