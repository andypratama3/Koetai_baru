                            ...
                            <div class="form-menu">
                                <div class="pilihan">
                                    ...
                                    <select name="tiket_id" class="form-select form-control tiket_id ">
                                        ...
                                        <option value="{{ $tiket->id }}" id="harga_tiket"
                                            data-harga="<?=$tiket->harga ?>">{{ $tiket->kategori }} || Harga Rp.
                                            {{ $tiket->harga }}</option>
                                        @endforeach
                                        <span id="harga"></span>
                                    ...
                                    <div class="tombol-pesantik">
                                        <button type="submit" class="btn btn-primary btn-lg pesan-tiket pay-button">Pesan Tiket</button>
                                    </div>
                                    {{-- </form> --}}
                                </div>
                            </div>
